...
- [ ] **Step 3 — adversarial golden fixtures for source ingestion** (§ Verification pipeline step 3; locked test cases 16–17). Not started. Must land before step 4 — the judge should never be the first line of defense against a hostile source.
